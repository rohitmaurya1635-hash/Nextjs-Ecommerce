...
const breadcrumbData = [
    ...
    { label: 'Orders', href: ADMIN_ORDERS_SHOW },
            ...
            <Card className='py-0 rounded shadow-sm gap-0'>
                <CardHeader className='pt-2 px-3 border-b [.border-b]:pb-2'>
                    <div className='flex justify-between items-center'>
                        <h4 className='font-semibold text-xl uppercase text-primary'>Order Details</h4>
                    </div>
                </CardHeader>
                <CardContent>
                    {!orderData ?
                        ...
                        <div>
                            <div className="mb-5">
                                ...
                                <p className="capitalize"><b>Status:</b> {orderData?.orderStatus}</p>
                            </div>
                                        ...
                                        <tr key={product?.variantId._id} className='md:table-row block border-b'>
                                            <td className='p-3'>
                                                <div className='flex items-center gap-5'>
                                                    <Image
                                                        src={product?.variantId?.media[0].secure_url || '/assets/images/img-placeholder.webp'}
                                                        width={60}
                                                        height={60}
                                                        alt={product?.productId.slug || 'Product Image'}
                                                        className='rounded'
                                                    />
                                                    <div>
                                        ...
                                        <table className='w-full'>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className='text-end py-2'>{orderData?.total.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td className='font-medium py-2'>Grand Total</td>
                                                    <td className='text-end py-2'>{orderData?.grandTotal.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</td>
                                                </tr>
