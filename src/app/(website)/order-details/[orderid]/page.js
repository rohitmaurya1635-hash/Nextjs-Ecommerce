                ...
                {orderData && !orderData.success ?
                    ...
                    <div>
                        <div className="mb-5">
                            ...
                            <p className="capitalize"><b>Status:</b> {orderData?.data?.orderStatus}</p>
                        </div>
                                    ...
                                    <table className='w-full'>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className='text-end py-2'>{orderData?.data?.total.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className='text-end py-2'>{orderData?.data?.grandTotal.toLocaleString('en-IN', { style: 'currency', currency: 'INR' })}</td>
                                            </tr>
